...
am_rel_srcdir='.'
am_top_srcdir='/home/shun/linux/tool/buildroot-2019.02.6/output/build/host-automake-1.15.1'
am_top_builddir='/home/shun/linux/tool/buildroot-2019.02.6/output/build/host-automake-1.15.1'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/home/shun/linux/tool/buildroot-2019.02.6/output/host/share/automake-1.15/am'
    am_automake_acdir='/home/shun/linux/tool/buildroot-2019.02.6/output/host/share/aclocal-1.15'
    am_bindir='/home/shun/linux/tool/buildroot-2019.02.6/output/host/bin'
    am_datadir='/home/shun/linux/tool/buildroot-2019.02.6/output/host/share'
    am_docdir='/home/shun/linux/tool/buildroot-2019.02.6/output/host/share/doc/automake'
    am_pkgvdatadir='/home/shun/linux/tool/buildroot-2019.02.6/output/host/share/automake-1.15'
    am_scriptdir='/home/shun/linux/tool/buildroot-2019.02.6/output/host/share/automake-1.15'
    am_system_acdir='/home/shun/linux/tool/buildroot-2019.02.6/output/host/share/aclocal'
    ;;
  no)
...
CFLAGS=${AM_TESTSUITE_CFLAGS-${CFLAGS-'-O2 -I/home/shun/linux/tool/buildroot-2019.02.6/output/host/include'}}
CXXFLAGS=${AM_TESTSUITE_CXXFLAGS-${CXXFLAGS-'-O2 -I/home/shun/linux/tool/buildroot-2019.02.6/output/host/include'}}
FCFLAGS=${AM_TESTSUITE_FCFLAGS-${FCFLAGS-''}}
FFLAGS=${AM_TESTSUITE_FFLAGS-${FFLAGS-''}}
CPPFLAGS=${AM_TESTSUITE_CPPFLAGS-${CPPFLAGS-'-I/home/shun/linux/tool/buildroot-2019.02.6/output/host/include'}}
...
GNU_CXXFLAGS=${AM_TESTSUITE_GNU_CXXFLAGS-${GNU_CXXFLAGS-'-O2 -I/home/shun/linux/tool/buildroot-2019.02.6/output/host/include'}}
GNU_CFLAGS=${AM_TESTSUITE_GNU_CFLAGS-${GNU_CFLAGS-'-O2 -I/home/shun/linux/tool/buildroot-2019.02.6/output/host/include'}}
